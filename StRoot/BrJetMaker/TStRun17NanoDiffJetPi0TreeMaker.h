// Filename: TStRun17NanoDiffJetPi0TreeMaker.h
// Description: 
// Author: Latif Kabir < kabir@bnl.gov >
// Created: Mon Aug 19 17:38:04 2019 (-0400)
// URL: jlab.org/~latif

#ifndef TSTRUN17NANODIFFJETPI0TREEMAKER_H
#define TSTRUN17NANODIFFJETPI0TREEMAKER_H
...
class TStRun17NanoDiffJetPi0TreeMaker : public StMaker
{
private:
    StMuDst *mMuDst;  
    StEvent* mEvent;
...
public: 
    TStRun17NanoDiffJetPi0TreeMaker(const char *name  = "NanoJetTreeMaker");
    virtual ~TStRun17NanoDiffJetPi0TreeMaker();
    virtual Int_t Init();
    virtual Int_t Make();
    ...
    ClassDef(TStRun17NanoDiffJetPi0TreeMaker,1) 
};
