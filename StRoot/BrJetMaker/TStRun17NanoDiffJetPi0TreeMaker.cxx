// Filename: TStRun17NanoDiffJetPi0TreeMaker.cxx
// Description: 
...
#include "TStRun17NanoDiffJetPi0TreeMaker.h"
...
ClassImp(TStRun17NanoDiffJetPi0TreeMaker)

//_____________________________________________________________________________ 
TStRun17NanoDiffJetPi0TreeMaker::TStRun17NanoDiffJetPi0TreeMaker(const char *name):StMaker(name)
{
...
//_____________________________________________________________________________ 
TStRun17NanoDiffJetPi0TreeMaker::~TStRun17NanoDiffJetPi0TreeMaker()
{
    //
    delete mOutJetEvent;
...
//_____________________________________________________________________________ 
Int_t TStRun17NanoDiffJetPi0TreeMaker::Init()
{
...
//_____________________________________________________________________________
Int_t TStRun17NanoDiffJetPi0TreeMaker::Make()
{
    ...
    {
	LOG_ERROR << "TStRun17NanoDiffJetPi0TreeMaker::Make - No JetMaker or SkimEventMaker found" <<endm;
	return kStFatal;	
    }
...
//_____________________________________________________________________________
Int_t TStRun17NanoDiffJetPi0TreeMaker::MakeRps()
{
    //------ Using afterburner ----
...
//_____________________________________________________________________________
Int_t TStRun17NanoDiffJetPi0TreeMaker::Finish()
{
...
//_____________________________________________________________________________
//void TStRun17NanoDiffJetPi0TreeMaker::SetTrigIds(Int_t *trigIds)
//{
