...
#include "TStRpFilterMaker_zerobias.h"
#include "StMuDSTMaker/COMMON/StMuDst.h"
#include "StMuDSTMaker/COMMON/StMuEvent.h"

ClassImp(TStRpFilterMaker_zerobias)

TStRpFilterMaker_zerobias::TStRpFilterMaker_zerobias(const char *name) : StMaker(name), mPrint(0) { mRunPeriod = 15;}

TStRpFilterMaker_zerobias::~TStRpFilterMaker_zerobias()
{
    mGoodTriggers.clear();
    mVetoTriggers.clear();
}

Int_t TStRpFilterMaker_zerobias::Init()
{
...
Int_t TStRpFilterMaker_zerobias::Make()
{
    mMuDst = (StMuDst*)GetInputDS("MuDst");
    hEvtCount->Fill(1);

    //cout << "run Period:" << mRunPeriod << endl;
    if(mPrint)
    {
