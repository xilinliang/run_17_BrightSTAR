...
void runBfcFms(int nevents = -1,
	       ...
	       const char* chainopt = "DbV20220729 y2017 MakeEvent ITTF NoSsdIt NoSvtIt Idst BAna l0 Tree logger Sti VFPPVnoCTB beamLine tpcDB TpcHitMover TpxClu fmsDb fmsSim fmspoint  tags emcY2 EEfs eess evout -dstout IdTruth geantout big fzin MiniMcMk clearmem  sdt20150417.193427" //Mriganka
	       // const char* chainopt = "DbV20150923 y2015 MakeEvent ITTF NoSsdIt NoSvtIt Idst BAna l0 Tree logger Sti VFPPVnoCTB beamLine tpcDB TpcHitMover TpxClu fmsDb fmsSim fmspoint  eemcA2E eemcDb eess tags emcY2 EEfs evout -dstout IdTruth geantout big fzin MiniMcMk clearmem  sdt20150417.193427" // EEMC TEST!!!!!!!!!!!
    ) 
{  
