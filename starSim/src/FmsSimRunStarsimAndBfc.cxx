...
void FmsSimRunStarsimAndBfc(Int_t cycle, Int_t nEvents, Int_t filterThres)
{
    TString kumacFile = "starSim/pythia.kumac";
    ...
    TString fileName = "FmsSim_Run17_" + to_string(cycle) + Form("_evt%i", nEvents) + ".fzd";   
    ...
    TString bfcMacro =  "starSim/src/FmsSimRunBfc.C(-1,\"" + fileName + "\"" + Form(",%i", filterThres) + ")";
    cout << bfcMacro <<endl;
