...
void DiffJetXFCalcRun17_WestRP(TString inFileName, TString outName, TString mode, TString det)
{
    ...
    TH1I *h1_cut_status = new TH1I("h1_cut_status","n events after cuts",6,0,6);
    ...
    TH2D *h2_BBCW_vs_BBCE_signal = new TH2D("h2_BBCW_vs_BBCE_signal","small BBC west ADC vs small BBC east ADC (signal);small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_bkg = new TH2D("h2_BBCW_vs_BBCE_bkg","small BBC west ADC vs small BBC east ADC (bkg);small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_elastic = new TH2D("h2_BBCW_vs_BBCE_elastic","small BBC west ADC vs small BBC east ADC (elastic scattering);small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_signal_xF1015 = new TH2D("h2_BBCW_vs_BBCE_signal_xF1015","small BBC west ADC vs small BBC east ADC (signal) 0.10 < x_{F} < 0.15;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_signal_xF1520 = new TH2D("h2_BBCW_vs_BBCE_signal_xF1520","small BBC west ADC vs small BBC east ADC (signal) 0.15 < x_{F} < 0.20;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_signal_xF2025 = new TH2D("h2_BBCW_vs_BBCE_signal_xF2025","small BBC west ADC vs small BBC east ADC (signal) 0.20 < x_{F} < 0.25;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_signal_xF2530 = new TH2D("h2_BBCW_vs_BBCE_signal_xF2530","small BBC west ADC vs small BBC east ADC (signal) 0.25 < x_{F} < 0.30;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_signal_xF3045 = new TH2D("h2_BBCW_vs_BBCE_signal_xF3045","small BBC west ADC vs small BBC east ADC (signal) 0.30 < x_{F} < 0.45;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_bkg_xF1015 = new TH2D("h2_BBCW_vs_BBCE_bkg_xF1015","small BBC west ADC vs small BBC east ADC (bkg) 0.10 < x_{F} < 0.15;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_bkg_xF1520 = new TH2D("h2_BBCW_vs_BBCE_bkg_xF1520","small BBC west ADC vs small BBC east ADC (bkg) 0.15 < x_{F} < 0.20;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_bkg_xF2025 = new TH2D("h2_BBCW_vs_BBCE_bkg_xF2025","small BBC west ADC vs small BBC east ADC (bkg) 0.20 < x_{F} < 0.25;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_bkg_xF2530 = new TH2D("h2_BBCW_vs_BBCE_bkg_xF2530","small BBC west ADC vs small BBC east ADC (bkg) 0.25 < x_{F} < 0.30;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    TH2D *h2_BBCW_vs_BBCE_bkg_xF3045 = new TH2D("h2_BBCW_vs_BBCE_bkg_xF3045","small BBC west ADC vs small BBC east ADC (bkg) 0.30 < x_{F} < 0.45;small BBC east ADC;small BBC west ADC",200,0,8000,200,0,8000);
    ...
    TH1D *h1_smallBBCsumEast_elastic = new TH1D("h1_smallBBCsumEast_elastic","small BBC ADC sum for east side BBC (elastic scattering)",400,0,8000);
    TH1D *h1_smallBBCsumWest_elastic = new TH1D("h1_smallBBCsumWest_elastic","small BBC ADC sum for west side BBC (elastic scattering)",400,0,8000);
    TH2D *h2_RPtrkEwest_vs_smallBBCsumWest_elastic = new TH2D("h2_RptrkEwest_vs_smallBBCsumWest_elastic","west side RP track energy vs small BBC ADC sum for west side BBC (elastic scattering);small BBC sum;energy[GeV]",200,0,10000,100,180.0,280.0);
    TH2D *h2_RPtrkEeast_vs_smallBBCsumEast_elastic = new TH2D("h2_RptrkEeast_vs_smallBBCsumEast_elastic","east side RP track energy vs small BBC ADC sum for east side BBC (elastic scattering);small BBC sum;energy[GeV]",200,0,10000,100,180.0,280.0);
    ...
    TH1D *h1_EastRpP = new TH1D("h1_EastRpP", "East RP trk P;P [GeV/c]", 100, 30.0, 280.0);
    TH1D *h1_WestRpP = new TH1D("h1_WestRpP", "West RP trk P;P [GeV/c]", 100, 30.0, 280.0);
    TH1D *h1_EastRpP_doublediff = new TH1D("h1_EastRpP_doublediff", "East RP trk P for double diffractive process;P [GeV/c]", 100, 30.0, 280.0);
    TH1D *h1_WestRpP_doublediff = new TH1D("h1_WestRpP_doublediff", "West RP trk P for double diffractive process;P [GeV/c]", 100, 30.0, 280.0);
    TH1D *h1_WestRpP_singlediff = new TH1D("h1_WestRpP_singlediff", "West RP trk P for single diffractive process;P [GeV/c]", 100, 30.0, 280.0);
    ...
    TH1D *h1_EastWestRP_Pdiff = new TH1D("h1_EastWestRP_Pdiff", "|P_{West RP track} - P_{East RP track}| ; #Delta P", 80, 0,40);
    TH1D *h1_EastWestRP_PxSum = new TH1D("h1_EastWestRP_PxSum", "|Px_{West RP track} + Px_{East RP track}| ; |sum Px|", 80, 0,1);
    TH1D *h1_EastWestRP_PySum = new TH1D("h1_EastWestRP_PySum", "|Py_{West RP track} + Py_{East RP track}| ; |sum Py|", 80, 0,1);
    TH2D *h2_WestRpPyP_elastic = new TH2D("h2_WestRpPyP_elastic","West Roman Pot track P_{y} vs P (elastic scattering events) ;P [GeV/c];P_{y} [GeV/c]",100,120.0,280.0,100,-2.0,2.0);


    TH1D *h1_sumEwest = new TH1D("h1_sumEwest","sum of west side RP track energy and EM Jet energy;sum E [GeV]",200, 120.0, 420.0);
    TH1D *h1_sumEwest_XF0510 = new TH1D("h1_sumEwest_XF0510","sum of west side RP track energy and EM Jet energy (0.05< x_{F} < 0.1 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_XF1015 = new TH1D("h1_sumEwest_XF1015","sum of west side RP track energy and EM Jet energy (0.1 < x_{F} < 0.15) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_XF1520 = new TH1D("h1_sumEwest_XF1520","sum of west side RP track energy and EM Jet energy (0.15 < x_{F} < 0.2 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_XF2025 = new TH1D("h1_sumEwest_XF2025","sum of west side RP track energy and EM Jet energy (0.2 < x_{F} < 0.25) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_XF2530 = new TH1D("h1_sumEwest_XF2530","sum of west side RP track energy and EM Jet energy (0.25 < x_{F} < 0.3 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_XF3035 = new TH1D("h1_sumEwest_XF3035","sum of west side RP track energy and EM Jet energy (0.3  < x_{F} < 0.35) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_XF3540 = new TH1D("h1_sumEwest_XF3540","sum of west side RP track energy and EM Jet energy (0.35 < x_{F} < 0.4 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_XF4045 = new TH1D("h1_sumEwest_XF4045","sum of west side RP track energy and EM Jet energy (0.4  < x_{F} < 0.45) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_XF30 = new TH1D("h1_sumEwest_XF30","sum of west side RP track energy and EM Jet energy (x_{F} > 0.3 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF0510 = new TH1D("h1_sumEwest_12np_XF0510","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (0.05< x_{F} < 0.1 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF1015 = new TH1D("h1_sumEwest_12np_XF1015","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (0.1 < x_{F} < 0.15) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF1520 = new TH1D("h1_sumEwest_12np_XF1520","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (0.15 < x_{F} < 0.2 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF2025 = new TH1D("h1_sumEwest_12np_XF2025","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (0.2 < x_{F} < 0.25) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF2530 = new TH1D("h1_sumEwest_12np_XF2530","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (0.25 < x_{F} < 0.3 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF3035 = new TH1D("h1_sumEwest_12np_XF3035","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (0.3  < x_{F} < 0.35) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF3540 = new TH1D("h1_sumEwest_12np_XF3540","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (0.35 < x_{F} < 0.4 ) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF4045 = new TH1D("h1_sumEwest_12np_XF4045","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (0.4  < x_{F} < 0.45) );sum E [GeV]",280, 120.0, 400.0);
    TH1D *h1_sumEwest_12np_XF30 = new TH1D("h1_sumEwest_12np_XF30","sum of west side RP track energy and EM Jet energy n_{photon} < 2 (x_{F} > 0.3 ) );sum E [GeV]",280, 120.0, 400.0);
    ...
    TH1D *h1_wRpP_xF1015 = new TH1D("h1_trkPWest_xF1015", "West RP trk P (EM-jet 0.1 < x_{F} < 0.15); RP track P [GeV/c]", 270, 0., 270.);
    TH1D *h1_wRpP_xF1520 = new TH1D("h1_trkPWest_xF1520", "West RP trk P (EM-jet 0.15< x_{F} < 0.2 ); RP track P [GeV/c]", 270, 0., 270.);
    TH1D *h1_wRpP_xF2025 = new TH1D("h1_trkPWest_xF2025", "West RP trk P (EM-jet 0.2 < x_{F} < 0.25); RP track P [GeV/c]", 270, 0., 270.);
    TH1D *h1_wRpP_xF2530 = new TH1D("h1_trkPWest_xF2530", "West RP trk P (EM-jet 0.25< x_{F} < 0.3 ); RP track P [GeV/c]", 270, 0., 270.);
    TH1D *h1_wRpP_xF3035 = new TH1D("h1_trkPWest_xF3035", "West RP trk P (EM-jet 0.3 < x_{F} < 0.35); RP track P [GeV/c]", 270, 0., 270.);
    TH1D *h1_wRpP_xF3540 = new TH1D("h1_trkPWest_xF3540", "West RP trk P (EM-jet 0.35< x_{F} < 0.4 ); RP track P [GeV/c]", 270, 0., 270.);
    TH1D *h1_wRpP_xF4045 = new TH1D("h1_trkPWest_xF4045", "West RP trk P (EM-jet 0.4 < x_{F} < 0.45); RP track P [GeV/c]", 270, 0., 270.);
    ...
    TH1D *h1_pT_sum = new TH1D("h1_pT_sum","sum of west RP track and Ej-jet p_{T};sum p_{T}",100,-5,5);
    ...
    TH1D *h1_xF_2545 = new TH1D("h1_xF_2545","x_{F} distribution in [0.25,0.45];x_{F}",50,0.25,0.45);

    TH1D *h1_xF_1015_12np = new TH1D("h1_xF_1015_12np","x_{F} distribution in [0.1,0.15] (1 or 2 photon mult);x_{F}",50,0.1,0.15);
    TH1D *h1_xF_1520_12np = new TH1D("h1_xF_1520_12np","x_{F} distribution in [0.15,0.2] (1 or 2 photon mult);x_{F}",50,0.15,0.2);
    TH1D *h1_xF_2025_12np = new TH1D("h1_xF_2025_12np","x_{F} distribution in [0.2,0.25] (1 or 2 photon mult);x_{F}",50,0.2,0.25);
    TH1D *h1_xF_2530_12np = new TH1D("h1_xF_2530_12np","x_{F} distribution in [0.25,0.3] (1 or 2 photon mult);x_{F}",50,0.25,0.3);
    TH1D *h1_xF_3035_12np = new TH1D("h1_xF_3035_12np","x_{F} distribution in [0.3,0.35] (1 or 2 photon mult);x_{F}",50,0.3,0.35);
    TH1D *h1_xF_3540_12np = new TH1D("h1_xF_3540_12np","x_{F} distribution in [0.35,0.4] (1 or 2 photon mult);x_{F}",50,0.35,0.4);
    TH1D *h1_xF_4045_12np = new TH1D("h1_xF_4045_12np","x_{F} distribution in [0.4,0.45] (1 or 2 photon mult);x_{F}",50,0.4,0.45);
    TH1D *h1_xF_3045_12np = new TH1D("h1_xF_3045_12np","x_{F} distribution in [0.3,0.45] (1 or 2 photon mult);x_{F}",50,0.3,0.45);
    TH1D *h1_xF_2545_12np = new TH1D("h1_xF_2545_12np","x_{F} distribution in [0.25,0.45] (1 or 2 photon mult);x_{F}",50,0.25,0.45);
    ...
    TH1D *h1_xF_1015_Sys = new TH1D("h1_xF_1015_Sys","x_{F} distribution in [0.1,0.15] (Systematic uncertainty);x_{F}",50,0.1,0.15);
    TH1D *h1_xF_1520_Sys = new TH1D("h1_xF_1520_Sys","x_{F} distribution in [0.15,0.2] (Systematic uncertainty);x_{F}",50,0.15,0.2);
    TH1D *h1_xF_2025_Sys = new TH1D("h1_xF_2025_Sys","x_{F} distribution in [0.2,0.25] (Systematic uncertainty);x_{F}",50,0.2,0.25);
    TH1D *h1_xF_2530_Sys = new TH1D("h1_xF_2530_Sys","x_{F} distribution in [0.25,0.3] (Systematic uncertainty);x_{F}",50,0.25,0.3);
    TH1D *h1_xF_3035_Sys = new TH1D("h1_xF_3035_Sys","x_{F} distribution in [0.3,0.35] (Systematic uncertainty);x_{F}",50,0.3,0.35);
    TH1D *h1_xF_3045_Sys = new TH1D("h1_xF_3045_Sys","x_{F} distribution in [0.3,0.45] (Systematic uncertainty);x_{F}",50,0.3,0.45);
    TH1D *h1_xF_2545_Sys = new TH1D("h1_xF_2545_Sys","x_{F} distribution in [0.25,0.45] (Systematic uncertainty);x_{F}",50,0.25,0.45);
    TH1D *h1_xF_1015_12np_Sys = new TH1D("h1_xF_1015_12np_Sys","x_{F} distribution in [0.1,0.15] (Systematic uncertainty, 12np);x_{F}",50,0.1,0.15);
    TH1D *h1_xF_1520_12np_Sys = new TH1D("h1_xF_1520_12np_Sys","x_{F} distribution in [0.15,0.2] (Systematic uncertainty, 12np);x_{F}",50,0.15,0.2);
    TH1D *h1_xF_2025_12np_Sys = new TH1D("h1_xF_2025_12np_Sys","x_{F} distribution in [0.2,0.25] (Systematic uncertainty, 12np);x_{F}",50,0.2,0.25);
    TH1D *h1_xF_2545_12np_Sys = new TH1D("h1_xF_2545_12np_Sys","x_{F} distribution in [0.25,0.45] (Systematic uncertainty, 12np);x_{F}",50,0.25,0.45);
    ...
    TH2D *h2_EMJetE_vs_ProtonE_noRpPcut = new TH2D("h2_EmJetE_vs_ProtonE_noRpPcut", "EM Jet sum Energy vs West Proton Energy (no RP P cut); West Proton Energy [GeV]; EM Jet sum Energy [GeV]", 100, 180.0, 280.0, 100, 5.0, 105.0);
    ...
    TH2D *h2_BU_xF_vs_phi_bkg = new TH2D("h2_BU_xF_vs_phi_bkg","Blue beam spin +1 x_{F} vs #phi (bkg); #phi [rad] ; x_{F}",Phibin,-TMath::Pi(),TMath::Pi(),XFbin,0,1);
    TH2D *h2_BD_xF_vs_phi_bkg = new TH2D("h2_BD_xF_vs_phi_bkg","Blue beam spin -1 x_{F} vs #phi (bkg); #phi [rad] ; x_{F}",Phibin,-TMath::Pi(),TMath::Pi(),XFbin,0,1);
    TH2D *h2_YU_xF_vs_phi_bkg = new TH2D("h2_YU_xF_vs_phi_bkg","Yellow beam spin +1 x_{F} vs #phi (bkg); #phi [rad] ; x_{F}",Phibin,-TMath::Pi(),TMath::Pi(),XFbin,0,1);
    TH2D *h2_YD_xF_vs_phi_bkg = new TH2D("h2_YD_xF_vs_phi_bkg","Yellow beam spin -1 x_{F} vs #phi (bkg); #phi [rad] ; x_{F}",Phibin,-TMath::Pi(),TMath::Pi(),XFbin,0,1);
    TH2D *h2_BU_xF_vs_phi_nPhoton12_bkg = new TH2D("h2_BU_xF_vs_phi_nPhoton12_bkg","Blue beam spin +1 x_{F} vs #phi (bkg); #phi [rad] ; x_{F}",Phibin,-TMath::Pi(),TMath::Pi(),XFbin,0,1);
    TH2D *h2_BD_xF_vs_phi_nPhoton12_bkg = new TH2D("h2_BD_xF_vs_phi_nPhoton12_bkg","Blue beam spin -1 x_{F} vs #phi (bkg); #phi [rad] ; x_{F}",Phibin,-TMath::Pi(),TMath::Pi(),XFbin,0,1);
    TH2D *h2_YU_xF_vs_phi_nPhoton12_bkg = new TH2D("h2_YU_xF_vs_phi_nPhoton12_bkg","Yellow beam spin +1 x_{F} vs #phi (bkg); #phi [rad] ; x_{F}",Phibin,-TMath::Pi(),TMath::Pi(),XFbin,0,1);
    TH2D *h2_YD_xF_vs_phi_nPhoton12_bkg = new TH2D("h2_YD_xF_vs_phi_nPhoton12_bkg","Yellow beam spin -1 x_{F} vs #phi (bkg); #phi [rad] ; x_{F}",Phibin,-TMath::Pi(),TMath::Pi(),XFbin,0,1);
    ...
    f2a->SetParameter(1,9.99575e-01);
    	...
    	TF1 *f4 = new TF1("f4","[0]+[1]*x+[2]*x");
    	f4->SetParameter(0,3.74583e+00);
    	f4->SetParameter(1,7.54344e-01);
    	f4->SetParameter(2,4.59049e-03);
    	TF1 *f5 = new TF1("f5","[0]+[1]*x+[2]*x");
    	f5->SetParameter(0,-8.79371e-01);
    	f5->SetParameter(1,1.08689e+00);
    	f5->SetParameter(2,-7.84053e-04);
    ...
    Double_t jetX, jetY, eta, phi, theta, vtxZ, eng, eng_corr, eng_corr_sys, eng_corr_diff, pt,nEMjets_cut,xF,xF_corr;
    Int_t nJets = 0;
    bool isbkg;
    bool issig;
	...
	Double_t EastRpP=0;
	Double_t WestRpP=0;
	Double_t RpPx, RpPy, EastRpPx, EastRpPy, WestRpPx, WestRpPy , WestRpPt, xF_nocut , WestRpXi , EastRpXi;
	bool goodevent=false;
	bool goodeventE=false;
	...
	{	
		...
		if(rpsTrack->GetBranch() == 0 || rpsTrack->GetBranch() == 1) //East RP :: O East Up RP, 1: East Down RP
			...
			//continue;
				...
				if ((EastRpXi > 0.0) && (EastRpXi < 0.45) && (rpsTrack->GetNplanes()>=7)) {goodeventE = true;}
		...
		else 
		{
			if(rpsTrack->GetBranch() == 2 || rpsTrack->GetBranch() == 3) // 2:  West Up RP, 3: West Down RP
				...
				WestRpPt = rpsTrack->GetPt();
				WestRpPy = rpsTrack->GetPy();
				//if (rpsTrack->GetP() > 240) {goodevent=false;continue;}
				//continue;
		...
		if (rpsTrack->GetNplanes()<7) {goodevent=false;continue;}
		RpPx = rpsTrack->GetPx();
		RpPy = rpsTrack->GetPy();
		...
		//if (!((fabs(RpPx) < 0.5)&&(((RpPy < 0.4)&&(RpPy > 0.25)) || ((RpPy < -0.25)&&(RpPy > -0.4))))) {goodevent=false;continue;}
		//if (!((RpPx < 0.3)&&(RpPx > -0.5)&&(((RpPy < 0.4)&&(RpPy > 0.25)) || ((RpPy < -0.25)&&(RpPy > -0.4))))) {goodevent=false;continue;}
		//if (!((RpPx < 0.3)&&(RpPx > -0.25)&&(((RpPy < 0.55)&&(RpPy > 0.3)) || ((RpPy < -0.4)&&(RpPy > -0.6))))) {goodevent=false;continue;}


	}
	if ((nRpsTracksEast==2)||(nRpsTracksWest!=1)||(!goodevent)) {continue;}
	if ((nRpsTracksEast==1) && (!goodeventE)) {continue;}
...
//	if ((nRpsTracksEast==1)&&((skimEvent->GetBbcSumSmall(0) > 100)||(skimEvent->GetBbcSumLarge(0) > 60))) continue;
	...
	//		if (fabs(EastRpP - WestRpP) < 5) 
	//			{
	//				h2_BBCW_vs_BBCE_elastic->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));
	//				h1_smallBBCsumEast_elastic->Fill(skimEvent->GetBbcSumSmall(0));
	//				h1_smallBBCsumWest_elastic->Fill(skimEvent->GetBbcSumSmall(1));
	//				h1_EastWestRP_Pxdiff->Fill(fabs(fabs(WestRpPx) - fabs(EastRpPx)));
	//				h1_EastWestRP_Pydiff->Fill(fabs(fabs(WestRpPy) - fabs(EastRpPy)));
	//				h1_EastWestRP_PxSum->Fill(fabs(fabs(WestRpPx) + fabs(EastRpPx)));
	//				h1_EastWestRP_PySum->Fill(fabs(fabs(WestRpPy) + fabs(EastRpPy)));
	//				h2_RPtrkEwest_vs_smallBBCsumWest_elastic->Fill(skimEvent->GetBbcSumSmall(1),WestRpP);
	//				h2_RPtrkEeast_vs_smallBBCsumEast_elastic->Fill(skimEvent->GetBbcSumSmall(0),EastRpP);
	//				h2_WestRpPyP_elastic->Fill(WestRpP,WestRpPy);
	//				continue;
	//			}
	//	}

	//if ((nRpsTracksEast==1)&&(nRpsTracksWest==0)) continue;
	h1_cut_status->Fill(2);
	
	//if ((nRpsTracksWest==1)) continue;
	//if ((nRpsTracksEast==1)) continue;
	//if ((nRpsTracksEast==0)||(nRpsTracksWest==0)) {continue;}
	//if ((fabs(EastRpP - WestRpP) > 5)||(WestRpP < 245)) continue;
	...
	//	continue;
	    ...
	    //if (eng <= 5) {eng = 0;eng_corr = 0;}
	    //    else {eng_corr = f2->Eval(eng);}
...
//	    if (!good_emjet_pt) continue;
	...
	h1_cut_status->Fill(3);
	if (xF_nocut <= 0) continue;
	...
	//if (RpWestPpJetE < 260) {h2_BBCW_vs_BBCE_signal->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	//if (RpWestPpJetE >= 260) {h2_BBCW_vs_BBCE_bkg->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE < 260)&&(xF_nocut > 0.1)&&(xF_nocut < 0.15)) {h2_BBCW_vs_BBCE_signal_xF1015->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE < 260)&&(xF_nocut > 0.15)&&(xF_nocut < 0.2)) {h2_BBCW_vs_BBCE_signal_xF1520->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE < 260)&&(xF_nocut > 0.2)&&(xF_nocut < 0.25)) {h2_BBCW_vs_BBCE_signal_xF2025->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE < 260)&&(xF_nocut > 0.25)&&(xF_nocut < 0.3)) {h2_BBCW_vs_BBCE_signal_xF2530->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE < 260)&&(xF_nocut > 0.3)&&(xF_nocut < 0.45)) {h2_BBCW_vs_BBCE_signal_xF3045->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE >= 260)&&(xF_nocut > 0.1)&&(xF_nocut < 0.15)) {h2_BBCW_vs_BBCE_bkg_xF1015->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE >= 260)&&(xF_nocut > 0.15)&&(xF_nocut < 0.2)) {h2_BBCW_vs_BBCE_bkg_xF1520->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE >= 260)&&(xF_nocut > 0.2)&&(xF_nocut < 0.25)) {h2_BBCW_vs_BBCE_bkg_xF2025->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE >= 260)&&(xF_nocut > 0.25)&&(xF_nocut < 0.3)) {h2_BBCW_vs_BBCE_bkg_xF2530->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	if ((RpWestPpJetE >= 260)&&(xF_nocut > 0.3)&&(xF_nocut < 0.45)) {h2_BBCW_vs_BBCE_bkg_xF3045->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	//if ((WestRpP < 240) && (RpWestPpJetE < 260)) {h2_BBCW_vs_BBCE_signal->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	//if ((WestRpP >= 240) || (RpWestPpJetE >- 260)) {h2_BBCW_vs_BBCE_bkg->Fill(skimEvent->GetBbcSumSmall(0),skimEvent->GetBbcSumSmall(1));}
	//if ((det=="fms")&&(mode!="largeBBC")&&(mode!="smallBBC")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) > 450))) {continue;}}
	h1_cut_status->Fill(4);

	//if (skimEvent->GetBbcSumSmall(1) <= 1) continue;

	//if ((det=="fms")&&(mode!="largeBBC")&&(mode!="smallBBC")&&(mode!="smallBBCE")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) > 250)||(skimEvent->GetBbcSumSmall(0) < 150))) {continue;}}
	if ((det=="fms")&&(mode!="largeBBC")&&(mode!="smallBBC")&&(mode!="smallBBCE")) {if (((skimEvent->GetBbcSumSmall(1) > 80))) {continue;}}
	//if ((det=="fms")&&(mode!="largeBBC")&&(mode!="smallBBC")&&(mode!="smallBBCE")) {if ((nRpsTracksWest==1)&&(skimEvent->GetBbcSumSmall(0) < 150)) {continue;}}
	//if ((det=="fms")&&(mode=="smallBBC")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) > 400)||(skimEvent->GetBbcSumSmall(0) < 150))) {continue;}}
	//if ((det=="fms")&&(mode=="smallBBC")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) < 250)||(skimEvent->GetBbcSumSmall(1) > 550)||(skimEvent->GetBbcSumSmall(0) < 150))) {continue;}}
	if ((det=="fms")&&(mode=="smallBBC")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) < 250)||(skimEvent->GetBbcSumSmall(1) > 550))) {continue;}} //method 2

	//if ((det=="fms")&&(mode=="smallBBC")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) > 400))) {continue;}}
	//if ((det=="fms")&&(mode=="smallBBCE")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) > 250)||(skimEvent->GetBbcSumSmall(0) < 50))) {continue;}}
	//if ((det=="fms")&&(mode=="smallBBCE")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) > 250)||((skimEvent->GetBbcSumSmall(0) < 50)||(skimEvent->GetBbcSumSmall(0) > 150)))) {continue;}}
	if ((det=="fms")&&(mode=="smallBBCE")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) > 250)||((skimEvent->GetBbcSumSmall(0) > 150)))) {continue;}}
...
//	if ((det=="fms")&&(mode=="smallBBC")) {if ((nRpsTracksWest==1)&&((skimEvent->GetBbcSumSmall(1) > 105)||(skimEvent->GetBbcSumLarge(1) > 60))) {continue;}}
	...
	if (nRpsTracksWest==1) 
	{
		h1_sumEwest->Fill(RpWestPpJetE);
		h2_EMJetE_vs_ProtonE_noRpPcut->Fill(WestRpP, (RpWestPpJetE - WestRpP)); 
		if (WestRpP < 240) {h2_EMJetE_vs_ProtonE->Fill(WestRpP, (RpWestPpJetE - WestRpP));}
	}
	//if (WestRpP > 240) {continue;}
	...
	//	else {if ((eng > 10)&&(eng < 60)) {eng_corr = f2->Eval(eng);} else {eng_corr = eng;}}
	    ...
	    //if (det == "eemc") {xF = eng * tanh(eta) / 100.;}
	    xF = 0;
 	    if (det == "fms") {xF = eng_corr / 255.;}
	    if (det == "eemc") {xF = eng_corr * tanh(eta) / 100.;}
	    //cout << "XF after cuts:" << xF << endl;
	    //bool good_emjet_pt = false;
	    //for(Int_t t = 0; t < 9; ++t) 
	    //{
	    //    if(skimEvent->GetTrigFlag(t))
	    ...
	    if ((xF > 0.05)&& (xF < 0.1)) {h1_sumEwest_XF0510->Fill(RpWestPpJetE); }
	    if ((xF > 0.1)&& (xF < 0.15)) {h1_sumEwest_XF1015->Fill(RpWestPpJetE); h1_wRpP_xF1015->Fill(WestRpP);}
	    if ((xF > 0.15)&& (xF < 0.2)) {h1_sumEwest_XF1520->Fill(RpWestPpJetE); h1_wRpP_xF1520->Fill(WestRpP);}
	    if ((xF > 0.2)&& (xF < 0.25)) {h1_sumEwest_XF2025->Fill(RpWestPpJetE); h1_wRpP_xF2025->Fill(WestRpP);}
	    if ((xF > 0.25)&& (xF < 0.3)) {h1_sumEwest_XF2530->Fill(RpWestPpJetE); h1_wRpP_xF2530->Fill(WestRpP);}
	    if ((xF > 0.3)&& (xF < 0.35)) {h1_sumEwest_XF3035->Fill(RpWestPpJetE); h1_wRpP_xF3035->Fill(WestRpP);}
	    if ((xF > 0.35)&& (xF < 0.4)) {h1_sumEwest_XF3540->Fill(RpWestPpJetE); h1_wRpP_xF3540->Fill(WestRpP);}
	    if ((xF > 0.4)&& (xF < 0.45)) {h1_sumEwest_XF4045->Fill(RpWestPpJetE); h1_wRpP_xF4045->Fill(WestRpP);}
	    if ((xF > 0.3)&&(xF < 0.45 )) {h1_sumEwest_XF30->Fill(RpWestPpJetE);}


	    if (jet->GetNumberOfTowers() <= 2)
	    {

	    	if ((xF > 0.05)&& (xF < 0.1)) {h1_sumEwest_12np_XF0510->Fill(RpWestPpJetE);}
	    	if ((xF > 0.1)&& (xF < 0.15)) {h1_sumEwest_12np_XF1015->Fill(RpWestPpJetE);}
	    	if ((xF > 0.15)&& (xF < 0.2)) {h1_sumEwest_12np_XF1520->Fill(RpWestPpJetE);}
	    	if ((xF > 0.2)&& (xF < 0.25)) {h1_sumEwest_12np_XF2025->Fill(RpWestPpJetE);}
	    	if ((xF > 0.25)&& (xF < 0.3)) {h1_sumEwest_12np_XF2530->Fill(RpWestPpJetE);}
	    	if ((xF > 0.3)&& (xF < 0.35)) {h1_sumEwest_12np_XF3035->Fill(RpWestPpJetE);}
	    	if ((xF > 0.35)&& (xF < 0.4)) {h1_sumEwest_12np_XF3540->Fill(RpWestPpJetE);}
	    	if ((xF > 0.4)&& (xF < 0.45)) {h1_sumEwest_12np_XF4045->Fill(RpWestPpJetE);}
	    	if ((xF > 0.3)&&(xF < 0.45 )) {h1_sumEwest_12np_XF30->Fill(RpWestPpJetE);}
	    ...
	    //
	    //            //if ((xF<0.1)) continue;
	    //            //if ((xF<0.15)&&(RpWestPpJetE > 265)) continue;
	    //            //if ((xF<0.2)&&(RpWestPpJetE > 280)) continue;
	    //            //if ((xF<0.25)&&(RpWestPpJetE > 295)) continue;
	    //		//if ((xF<0.3)&&(RpWestPpJetE > 305)) continue;
	    //		//if ((xF<0.35)&&(RpWestPpJetE > 315)) continue;
	    //		//if ((xF<0.4)&&(RpWestPpJetE > 330)) continue;
	    //		//if ((xF<0.45)&&(RpWestPpJetE > 340)) continue;
	    //            //if (((xF>0.2)&&(xF<0.25))&&((RpWestPpJetE < 200))) continue;
	    //		if (((xF>0.25)&&(xF<0.3))&&((RpWestPpJetE < 220))) continue;
	    //		if (((xF>0.3)&&(xF<0.35))&&((RpWestPpJetE < 230))) continue;
	    //		if (((xF>0.35)&&(xF<0.4))&&((RpWestPpJetE < 240))) continue;
	    //		if (((xF>0.4)&&(xF<0.45))&&((RpWestPpJetE < 260))) continue;

	                if (((xF>0.1)&&(xF<0.15))&&((RpWestPpJetE < 260))) {issig=true;}
	                if (((xF>0.15)&&(xF<0.2))&&((RpWestPpJetE < 270))) {issig=true;}
	                if (((xF>0.2)&&(xF<0.25))&&((RpWestPpJetE < 280))) {issig=true;}
	                if (((xF>0.25)&&(xF<0.3))&&((RpWestPpJetE < 290))) {issig=true;}
	                if (((xF>0.3)&&(xF<0.35))&&((RpWestPpJetE < 310))) {issig=true;}
	                if (((xF>0.35)&&(xF<0.4))&&((RpWestPpJetE < 320))) {issig=true;}
	                if (((xF>0.4)&&(xF<0.45))&&((RpWestPpJetE < 340))) {issig=true;}

	    //            if (((xF>0.1)&&(xF<0.15))&&((RpWestPpJetE > 260))) {isbkg=true;}
	    //            if (((xF>0.15)&&(xF<0.2))&&((RpWestPpJetE > 270))) {isbkg=true;}
	    //            if (((xF>0.2)&&(xF<0.25))&&((RpWestPpJetE > 280))) {isbkg=true;}
	    //            if (((xF>0.25)&&(xF<0.3))&&((RpWestPpJetE > 290))) {isbkg=true;}
	    //            if (((xF>0.3)&&(xF<0.35))&&((RpWestPpJetE > 310))) {isbkg=true;}
	    //            if (((xF>0.35)&&(xF<0.4))&&((RpWestPpJetE > 320))) {isbkg=true;}
	    //            if (((xF>0.4)&&(xF<0.45))&&((RpWestPpJetE > 340))) {isbkg=true;}

	    //            //if (((xF>0.1)&&(xF<0.15))&&((RpWestPpJetE > 260))) continue;
	    //            //if (((xF>0.15)&&(xF<0.2))&&((RpWestPpJetE > 270)||(RpWestPpJetE<190))) continue;
	    //            //if (((xF>0.15)&&(xF<0.2))&&((RpWestPpJetE > 260))) continue;

	    //}
	    //else
	    //{
	    //
	    //            //if ((xF<0.1)&&(RpWestPpJetE > 250)) continue;
	    //            //if ((xF<0.15)&&(RpWestPpJetE > 255)) continue;
	    //            //if ((xF<0.2)&&(RpWestPpJetE > 265)) continue;
	    //            //if ((xF<0.25)&&(RpWestPpJetE > 275)) continue;
	    //		//if ((xF<0.3)&&(RpWestPpJetE > 290)) continue;
	    //		//if ((xF<0.35)&&(RpWestPpJetE > 300)) continue;
	    //		//if ((xF<0.4)&&(RpWestPpJetE > 310)) continue;
	    //		//if ((xF<0.45)&&(RpWestPpJetE > 320)) continue;
	    //            //if ((xF<0.1)) continue;
	    //            //if ((xF<0.15)&&(RpWestPpJetE > 285)) continue;
	    //            //if ((xF<0.2)&&(RpWestPpJetE > 300)) continue;
	    //            //if ((xF<0.25)&&(RpWestPpJetE > 315)) continue;
	    //		//if ((xF<0.3)&&(RpWestPpJetE > 325)) continue;
	    //		//if ((xF<0.35)&&(RpWestPpJetE > 335)) continue;
	    //		//if ((xF<0.4)&&(RpWestPpJetE > 350)) continue;
	    //		//if ((xF<0.45)&&(RpWestPpJetE > 360)) continue;
	    //            //if (((xF>0.1)&&(xF<0.15))&&((RpWestPpJetE > 280))) continue;
	    //            //if (((xF>0.15)&&(xF<0.2))&&((RpWestPpJetE > 280)||(RpWestPpJetE<180))) continue;
	    //            //if (((xF>0.2)&&(xF<0.25))&&((RpWestPpJetE > 280)||(RpWestPpJetE<190))) continue;
	    //		//if (((xF>0.25)&&(xF<0.3))&&((RpWestPpJetE > 280)||(RpWestPpJetE<220))) continue;
	    //		//if (((xF>0.3)&&(xF<0.35))&&((RpWestPpJetE > 290)||(RpWestPpJetE<220))) continue;
	    //            //if (((xF>0.2)&&(xF<0.25))&&((RpWestPpJetE < 190))) continue;
	    //		if (((xF>0.25)&&(xF<0.3))&&((RpWestPpJetE < 210))) continue;
	    //		if (((xF>0.3)&&(xF<0.35))&&((RpWestPpJetE < 220))) continue;
	    //		if (((xF>0.35)&&(xF<0.4))&&((RpWestPpJetE < 230))) continue;
	    //		if (((xF>0.4)&&(xF<0.45))&&((RpWestPpJetE < 250))) continue;

	    //            if (((xF>0.1)&&(xF<0.15))&&((RpWestPpJetE < 270))) {issig=true;}
	    //            if (((xF>0.15)&&(xF<0.2))&&((RpWestPpJetE < 280))) {issig=true;}
	    //            if (((xF>0.2)&&(xF<0.25))&&((RpWestPpJetE < 290))) {issig=true;}
	    //            if (((xF>0.25)&&(xF<0.3))&&((RpWestPpJetE < 200))) {issig=true;}
	    //            if (((xF>0.3)&&(xF<0.35))&&((RpWestPpJetE < 320))) {issig=true;}
	    //            if (((xF>0.35)&&(xF<0.4))&&((RpWestPpJetE < 330))) {issig=true;}
	    //            if (((xF>0.4)&&(xF<0.45))&&((RpWestPpJetE < 350))) {issig=true;}

	    //            if (((xF>0.1)&&(xF<0.15))&&((RpWestPpJetE > 270))) {isbkg=true;}
	    //            if (((xF>0.15)&&(xF<0.2))&&((RpWestPpJetE > 280))) {isbkg=true;}
	    //            if (((xF>0.2)&&(xF<0.25))&&((RpWestPpJetE > 290))) {isbkg=true;}
	    //            if (((xF>0.25)&&(xF<0.3))&&((RpWestPpJetE > 300))) {isbkg=true;}
	    //            if (((xF>0.3)&&(xF<0.35))&&((RpWestPpJetE > 320))) {isbkg=true;}
	    //            if (((xF>0.35)&&(xF<0.4))&&((RpWestPpJetE > 330))) {isbkg=true;}
	    //            if (((xF>0.4)&&(xF<0.45))&&((RpWestPpJetE > 350))) {isbkg=true;}
	    ...
	    if ((xF > 0.3)&& (xF < 0.45)) {h1_xF_3045->Fill(xF);}
	    if ((xF > 0.25)&& (xF < 0.45)) {h1_xF_2545->Fill(xF);}
	    if ((xF > 0.3)&& (xF < 0.35)) {h1_xF_3035->Fill(xF);}

	    if (jet->GetNumberOfTowers() <= 2)
	    {

	    	if ((xF > 0.1)&& (xF < 0.15)) {h1_xF_1015_12np->Fill(xF);}
	    	if ((xF > 0.15)&& (xF < 0.2)) {h1_xF_1520_12np->Fill(xF);}
	    	if ((xF > 0.2)&& (xF < 0.25)) {h1_xF_2025_12np->Fill(xF);}
	    	if ((xF > 0.25)&& (xF < 0.3)) {h1_xF_2530_12np->Fill(xF);}
	    	if ((xF > 0.3)&& (xF < 0.45)) {h1_xF_3045_12np->Fill(xF);}
	    	if ((xF > 0.25)&& (xF < 0.45)){h1_xF_2545_12np->Fill(xF);}
	    ...
	    if (mode == "Ecorr")
	    {
			...
			if ((eng > 7)&&(eng < 40)) {eng_corr = f2->Eval(eng); eng_corr_sys = f4->Eval(eng);eng_corr_diff = 1.0*fabs(eng_corr - eng_corr_sys)/eng_corr;} 
			else {if ((eng > 40)&&(eng <  90)) {eng_corr = f2a->Eval(eng); eng_corr_sys = f5->Eval(eng);eng_corr_diff = 1.0*fabs(eng_corr - eng_corr_sys)/eng_corr;} else {eng_corr = eng; eng_corr_diff = -1;}}
		xF_corr = 1.0 * eng_corr_sys / 255.;
	    	...
	    	if ((xF > 0.3)&& (xF < 0.35) && (eng_corr_diff > 0)) {h1_xF_3035_SysDiff->Fill(eng_corr_diff);}
	    	if ((xF > 0.35)&& (xF < 0.4) && (eng_corr_diff > 0)) {h1_xF_3540_SysDiff->Fill(eng_corr_diff);}
	    	if ((xF > 0.4)&& (xF < 0.45) && (eng_corr_diff > 0)) {h1_xF_4045_SysDiff->Fill(eng_corr_diff);}
	    	if ((xF > 0.3)&& (xF < 0.45) && (eng_corr_diff > 0)) {h1_xF_3045_SysDiff->Fill(eng_corr_diff);}
	    	if ((xF > 0.1)&& (xF < 0.15)) {h1_xF_1015_Sys->Fill(xF_corr);}
	    	if ((xF > 0.15)&& (xF < 0.2)) {h1_xF_1520_Sys->Fill(xF_corr);}
	    	if ((xF > 0.2)&& (xF < 0.25)) {h1_xF_2025_Sys->Fill(xF_corr);}
	    	if ((xF > 0.25)&& (xF < 0.3)) {h1_xF_2530_Sys->Fill(xF_corr);}
	    	if ((xF > 0.3)&& (xF < 0.45)) {h1_xF_3045_Sys->Fill(xF_corr);}
	    	if ((xF > 0.3)&& (xF < 0.35)) {h1_xF_3035_Sys->Fill(xF_corr);}
	    	if ((xF > 0.25)&& (xF < 0.45)) {h1_xF_2545_Sys->Fill(xF_corr);}

	    	if (jet->GetNumberOfTowers() <= 2)
		{
	    		if ((xF > 0.1)&& (xF < 0.15)) {h1_xF_1015_12np_Sys->Fill(xF_corr);}
	    		if ((xF > 0.15)&& (xF < 0.2)) {h1_xF_1520_12np_Sys->Fill(xF_corr);}
	    		if ((xF > 0.2)&& (xF < 0.25)) {h1_xF_2025_12np_Sys->Fill(xF_corr);}
	    		if ((xF > 0.25)&& (xF < 0.45)) {h1_xF_2545_12np_Sys->Fill(xF_corr);}
	    ...
	    //if ((xF > 0.3) && (xF < 0.45)) {xF = 0.325;}
	    if ((xF > 0.25) && (xF < 0.45)) {xF = 0.275;}
	    ...
	    //if (isbkg)
	    //{
	    //	if (skimEvent->GetSpinB() == 1) h2_BU_xF_vs_phi_bkg->Fill(phi,xF);
	    //	if (skimEvent->GetSpinB() == -1) h2_BD_xF_vs_phi_bkg->Fill(phi,xF);
	    //	if (skimEvent->GetSpinY() == 1) h2_YU_xF_vs_phi_bkg->Fill(Yphi,xF);
	    //	if (skimEvent->GetSpinY() == -1) h2_YD_xF_vs_phi_bkg->Fill(Yphi,xF);

	    //	if (jet->GetNumberOfTowers() <= 2)
	    //	{

	    //		if (skimEvent->GetSpinB() == 1) h2_BU_xF_vs_phi_nPhoton12_bkg->Fill(phi,xF);
	    //		if (skimEvent->GetSpinB() == -1) h2_BD_xF_vs_phi_nPhoton12_bkg->Fill(phi,xF);
	    //		if (skimEvent->GetSpinY() == 1) h2_YU_xF_vs_phi_nPhoton12_bkg->Fill(Yphi,xF);
	    //		if (skimEvent->GetSpinY() == -1) h2_YD_xF_vs_phi_nPhoton12_bkg->Fill(Yphi,xF);
	...
	if (finalcut) h1_cut_status->Fill(5);
