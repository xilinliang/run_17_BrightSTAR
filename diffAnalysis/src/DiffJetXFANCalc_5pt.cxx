...
void DiffJetXFANCalc_5pt(TString inFileName, TString outName, TString outNameText, TString det)
{
    ...
    int nDrawPoints = 5;
	Double_t Frac_sig[5];
    for (int i=0; i<5; i++) {Frac_file >> Frac_sig[i];}
    //int nDrawPoints = 7;
	...
	TH2D * temp = new TH2D("temp","A_{N}",8,0.1,0.35,20,-0.1,0.1);
	...
	ANplot->SaveAs("FMS_ANplot_5pt.pdf");
	ANplot->SaveAs("FMS_ANplot_5pt.png");
	ANplot->SaveAs("FMS_ANplot_5pt.root");
	...
	//ANplot->SetLeftMargin(0.05);
	//ANplot->SetRightMargin(0.05);
	TH2D * temp2 = new TH2D("temp2","A_{N}",8,0.1,0.35,20,-0.25,0.25);
	//TH2D * temp = new TH2D("temp","A_{N}",8,0.1,0.35,20,-0.05,0.05);
	...
	ANplot2->SaveAs("FMS_ANplot_5pt_sig.pdf");
	ANplot2->SaveAs("FMS_ANplot_5pt_sig.png");
	ANplot2->SaveAs("FMS_ANplot_5pt_sig.root");
