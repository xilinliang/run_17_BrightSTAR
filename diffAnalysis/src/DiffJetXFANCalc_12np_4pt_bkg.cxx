...
void DiffJetXFANCalc_12np_4pt_bkg(TString inFileName, TString outName, TString outNameText, TString det)
{
    ...
    BlueBeamUp = (TH2D*) file->Get("h2_BU_xF_vs_phi_nPhoton12_bkg");
    BlueBeamDown = (TH2D*) file->Get("h2_BD_xF_vs_phi_nPhoton12_bkg");
    YellowBeamUp = (TH2D*) file->Get("h2_YU_xF_vs_phi_nPhoton12_bkg");
    YellowBeamDown = (TH2D*) file->Get("h2_YD_xF_vs_phi_nPhoton12_bkg");
    polBlue_Allfill = (TH1D*) file->Get("polBlue_Allfill");
    polYellow_Allfill = (TH1D*) file->Get("polYellow_Allfill");
    h1_XF1015_12np = (TH1D*) file->Get("h1_xF_1015_12np");
    h1_XF1520_12np = (TH1D*) file->Get("h1_xF_1520_12np");
    h1_XF2025_12np = (TH1D*) file->Get("h1_xF_2025_12np");
    h1_XF2545_12np = (TH1D*) file->Get("h1_xF_2545_12np");
	...
	Double_t XFpoint[4];
	XFpoint[0] = h1_XF1015_12np->GetMean();
	XFpoint[1] = h1_XF1520_12np->GetMean();
	XFpoint[2] = h1_XF2025_12np->GetMean();
	XFpoint[3] = h1_XF2545_12np->GetMean();
	...
	TH2D * temp = new TH2D("temp","A_{N}",8,0.1,0.35,20,-0.08,0.08);
	...
	TLatex T2;
   	...
   	T2.DrawLatex(0.11,0.06,"Photon multiplicity: 1 or 2");
   	T2.DrawLatex(0.11,0.05,"#sqrt{s} = 510 GeV");
   	//T2.DrawLatex(0.11,-0.09,"3.0\% polarization scale uncertainty not shown");
	
	
	ANplot->SaveAs("FMS_ANplot_12np_4pt_bkg.pdf");
	ANplot->SaveAs("FMS_ANplot_12np_4pt_bkg.png");
	ANplot->SaveAs("FMS_ANplot_12np_4pt_bkg.root");
