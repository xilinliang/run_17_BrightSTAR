...
void DiffJetXFANCalc_12np_5pt(TString inFileName, TString outName, TString outNameText, TString det)
{
	...
	TLatex T2;
   	...
   	T2.DrawLatex(0.11,0.04,"p^{#uparrow} + p #rightarrow EM jet + p + X");
   	T2.DrawLatex(0.11,0.03,"#sqrt{s} = 510 GeV");
   	T2.DrawLatex(0.11,-0.04,"1.1\% polarization scale uncertainty not shown");
	
	
	ANplot->SaveAs("FMS_ANplot_nPhoton12_5pt.pdf");
	ANplot->SaveAs("FMS_ANplot_nPhoton12_5pt.png");
	ANplot->SaveAs("FMS_ANplot_nPhoton12_5pt.root");
