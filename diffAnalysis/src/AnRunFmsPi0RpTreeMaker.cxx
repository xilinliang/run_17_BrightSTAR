// Filename: AnRunFmsPi0RpTreeMaker.cxx
// Description: 
...
void AnRunFmsPi0RpTreeMaker(TString fileList, TString outFile)
{
...
//    else
    ...
    Int_t runNumber;    
	runNumber = TStRunList::GetRunFromFileName((string)fileList, "fms");
    ...
    nanoMaker->SetOutFileName((TString)"NanoDiffFMSpi0Tree_" + outFile);
    nanoMaker->SetEtaMax(etaMax);
    nanoMaker->SetEtaMin(etaMin);
    nanoMaker->SetRunPeriod(15);
    nanoMaker->SetThisMode("1FMSpi0");
