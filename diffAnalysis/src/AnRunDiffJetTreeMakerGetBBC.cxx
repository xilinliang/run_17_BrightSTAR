// Filename: AnRunDiffJetTreeMakerGetBBC.cxx
// Description: 
...
void AnRunDiffJetTreeMakerGetBBC(TString inFile, TString outFile, TString det, Bool_t isMC)
{
    TStopwatch sw;
    sw.Start();
    ...
    Int_t runNumber;    
    if(!isMC)
	runNumber = TStRunList::GetRunFromFileName((string)inFile, det);
    else
	runNumber = 16066000;
